...
class Blockchain {
  ...
  isChainValid() {
    for (let i = 1; i < this.chain.length; i++) {
      ...
      // TODO check current block for valid transactions
    }
    return true;
  }
}
...
const myWalletAddress = secp.getPublicKey(myPrivateKey);
...
await tx1.signTransaction(myPrivateKey);
...
// Tampering
dcoin.chain[1].transactions[0].amount = 1;

// Check if the chain is valid
console.log();
console.log("Blockchain valid?", dcoin.isChainValid());
//endregion`}
      />
    </Layout>
  );
